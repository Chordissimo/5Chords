...
struct AppDefaults: Decodable {
    ...
    enum CodingKeys: String, CodingKey {
        case GOOGLE_DATA_API_KEY, GOOGLE_DATA_API_URL, UPLOAD_ENDPOINT, YOUTUBE_ENDPOINT, STATUS_ENDPOINT, LIMITED_UPLOAD_FILE_SIZE, MAX_UPLOAD_FILE_SIZE, LIMITED_DURATION, MAX_DURATION, LIMITED_NUMBER_OR_SONGS, INTERVAL_START_ADJUSTMENT
    }
    ...
    init() {
        ...
        do {
            ...
            self.STATUS_ENDPOINT = plist.STATUS_ENDPOINT
