...
public struct AppDefaults {
    ...
    public static var UPLOAD_ENDPOINT: String {
        get { UserDefaults.standard.object(forKey: "UPLOAD_ENDPOINT") as? String ?? "https://production.aichords.pro/upload" }
    }

    public static var YOUTUBE_ENDPOINT: String {
        get { UserDefaults.standard.object(forKey: "YOUTUBE_ENDPOINT") as? String ?? "https://production.aichords.pro/youtube" }
    }

    public static var STATUS_ENDPOINT: String {
        get { UserDefaults.standard.object(forKey: "STATUS_ENDPOINT") as? String ?? "https://production.aichords.pro/status" }
    }
    ...
    public static var GUITAR_CHORDS_URL: String {
        get { UserDefaults.standard.object(forKey: "GUITAR_CHORDS_URL") as? String ?? "https://production.aichords.pro/chords/GuitarChords.json" }
    }

    public static var UKULELE_CHORDS_URL: String {
        get { UserDefaults.standard.object(forKey: "UKULELE_CHORDS_URL") as? String ?? "https://production.aichords.pro/chords/UkuleleChords.json" }
    }
